...
class IngredientService {
  ...
  static Future<List<Ingredient>> getAllWithInactive() async {
    try {
      ...
      throw Exception(
          'Error al cargar todos los ingredientes: ${response.statusCode}');
    } catch (e) {
  ...
  static Future<void> disable(int id) async {
    try {
      ...
      if (response.statusCode != 200) {
        ...
        throw Exception(
            'Error al desactivar ingrediente: ${response.statusCode}');
      }
    } catch (e) {
  ...
  static Future<void> restore(int id) async {
    try {
      ...
      if (response.statusCode != 200) {
        ...
        throw Exception(
            'Error al restaurar ingrediente: ${response.statusCode}');
      }
    } catch (e) {
